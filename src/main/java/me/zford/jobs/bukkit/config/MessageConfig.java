...
public class MessageConfig {
    ...
    private enum JobsMessageEnum {
        ...
        JOBS_INFO("ChatColor.YELLOW/jobs info <jobname> <break, place, kill, fish, craft, brew, enchant>ChatColor.WHITE - show how much each job is getting paid and for what."),
